...
└── Attack Scenarios: Comprehensive attack documentation
```
...
kubectl delete -f modules/lab/manifests/11-ephemeral-attack-scenarios.yaml
...
We welcome contributions to improve the ephemeral container lab:
