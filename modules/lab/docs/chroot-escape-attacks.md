...
This lab demonstrates how chroot-based container escapes can work when containers have CAP_SYS_CHROOT and access to a host-like filesystem. The lab focuses on privilege escalation, detection, and mitigation strategies.
