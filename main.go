...
func init() {
	...
	rootCmd.SetHelpFunc(func(cmd *cobra.Command, args []string) {
		...
		fmt.Println("  lab apply         Deploy the full attack lab (delegates to kubeshadow-attack-labs)")
		fmt.Println("  lab destroy       Tear down the attack lab")
		fmt.Println("  lab apply --manifest <file>  Deploy a single YAML scenario")
